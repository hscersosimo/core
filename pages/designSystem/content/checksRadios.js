    ...
    <>
      ...
      <div className="mb-5">
        ...
        <div className="form-check form-switch">
          ...
          >
            defaultChecked switch checkbox input
          </label>
        </div>
        <div className="form-check form-switch">
          <input
        ...
        <div className="form-check form-switch">
          ...
          >
            Disabled defaultChecked switch checkbox input
          </label>
        </div>
      </div>
        ...
        <div className="input-group">
          <div className="input-group-text">
            <input
              ...
              type="radio"
              value=""
              aria-label="Radio button htmlFor following text input"
            />
          </div>
          <input
            type="text"
      ...
      <p>
        ...
        rather than .form-check-label on the <code>label</code> elements.
        These toggle buttons can further be grouped in a button group if
        needed.
      </p>
      <div className="mb-5">
        <input
          ...
          autoComplete="off"
        />
        <label className="btn btn-primary mx-1" htmlFor="btn-check">
          Single toggle
        </label>
        ...
        <input
          ...
          autoComplete="off"
        />
        <label className="btn btn-primary mx-1" htmlFor="btn-check-2">
          defaultChecked
        </label>
        ...
        <input
          ...
          disabled
        />
        <label className="btn btn-primary mx-1" htmlFor="btn-check-3">
          Disabled
        </label>
      </div>
      ...
      <div className="mb-5">
        <input
          ...
          defaultChecked
        />
        <label className="btn btn-secondary mx-1" htmlFor="option1">
          defaultChecked
        </label>
        ...
        <input
          ...
          disabled
        />
        <label className="btn btn-secondary mx-1" htmlFor="option3">
          Disabled
        </label>
        ...
        <input
          ...
          autoComplete="off"
        />
        <label className="btn btn-secondary mx-1" htmlFor="option4">
          Radio
        </label>
      </div>
