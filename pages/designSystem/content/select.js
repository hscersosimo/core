const Select = () => {
  return (
    <>
      ...
      <div className="mb-5">
        <p>
          Datalists allow you to create a group of <code>options</code> that
          can be accessed (and autocompleted) from within an{" "}
          <code>input</code>. These are similar to <code>select</code>{" "}
          elements, but come with more menu styling limitations and
          differences. While most browsers and operating systems include
          some support htmlFor <code>datalist</code> elements, their styling
