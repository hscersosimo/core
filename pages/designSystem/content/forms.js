      ...
      <div className="mb-5">
        <div className="my-3">
          <input
            className="form-control"
            type="text"
            defaultValue="readOnly input here... (you cannot change this text)"
        ...
        <p>
          ...
          form styled as plain text, replace <code>.form-control</code> with{" "}
          <code>.form-control-plaintext</code> to remove the default form
