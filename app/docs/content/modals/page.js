  ...
  return (
    <>
      ...
      <Container>
        ...
        <h5 className="mt-5">Scrolling long content</h5>
        <div
          className="modal fade"
          id="exampleModalLong"
          tabIndex="-1"
            ...
            <div className="modal-content">
              ...
              <div className="modal-body" style={{ minHeight: "1500px" }}>
                <p>
                  ...
                  behavior for modals. Instead of repeating the text the modal,
                  we use an inline style set a minimum height, thereby extending
                  the length of the overall modal and demonstrating the overflow
        ...
        <h5 className="mt-5">Vertically centered</h5>
        <div
          className="modal fade"
        ...
        <h5 className="mt-5">Tooltips & Popovers</h5>
        <div
          className="modal fade"
